...
## P01 사용자 흐름 개정 (2026-09-15)
새 과제 버전에는 [P01 명세](P01_LEARNING_FLOW.md)가 기존 필수 검산/INITIAL 중심 순서보다 우선한다. 이전 순서는 기존 세션 호환성을 위한 기록으로 유지한다. 두 유형·두 모드의 내 결과물 검증, 직접 설명, 근거 중심 피드백과 재연습을 적용한다.
