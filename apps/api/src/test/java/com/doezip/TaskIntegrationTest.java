...
class TaskIntegrationTest {
    ...
    @Test void migrationReapplyDoesNotDuplicateSeedAndConstraintsHold() {
        ...
        assertThat(jdbc.queryForObject("select count(*) from tasks", Integer.class)).isEqualTo(6);
        assertThat(jdbc.queryForObject("select count(*) from rubric_dimensions", Integer.class)).isEqualTo(24);
        assertThat(jdbc.queryForObject("select count(*) from materials", Integer.class)).isEqualTo(11);
        ...
        assertThat(jdbc.queryForObject("select count(*) from materials where task_id='73333333-3333-4333-8333-333333333333'", Integer.class)).isEqualTo(4);
    ...
    @Test void readsDatabaseSampleWithOnlyPublicFields() throws Exception {
        ...
        assertThat(items).anySatisfy(item -> assertThat(item).isEqualTo(task));
