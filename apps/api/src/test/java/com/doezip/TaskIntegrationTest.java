...
class TaskIntegrationTest {
    static final String SAMPLE = "61111111-1111-4111-8111-111111111111";
    ...
    @Test void migrationReapplyDoesNotDuplicateSeedAndConstraintsHold() {
        ...
        assertThat(jdbc.queryForObject("select count(*) from rubric_dimensions", Integer.class)).isEqualTo(8);
