...
export function WorkspaceEditor({workspace,userId}:{workspace:Workspace;userId:string}){
 ...
 const writable=workspace.session.allowedActions.includes('WRITE_DRAFT')&&draft.status!=='locked';
