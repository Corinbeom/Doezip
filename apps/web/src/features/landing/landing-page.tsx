...
export function LandingPage(){return <LearningShell><div className={styles.page}>
  <section className={styles.hero} aria-labelledby="landing-title">
    <div className={styles.heroCopy}><p className={styles.eyebrow}>AI 활용 역량 훈련</p><h1 id="landing-title">AI의 답을 그대로 쓰지 않고,<br/><em>내 판단으로 완성하는 연습.</em></h1><p className={styles.lead}>되짚은 AI와 과제를 해결하는 과정에서 질문, 검증, 수정, 설명을 기록합니다. 결과만 채점하지 않고 어떻게 판단했는지 함께 돌아봅니다.</p><div className={styles.actions}><Link className={styles.primary} href="/tasks">과제 둘러보기<Arrow/></Link><a className={styles.secondary} href="#how-it-works">어떻게 연습하나요?<Arrow/></a></div><p className={styles.heroNote}>보고서 작성과 JavaScript 구현 과제를 바로 체험할 수 있습니다.</p></div>
  ...
  <section className={styles.finalCta}><div><p className={styles.eyebrow}>지금 시작하기</p><h2>AI와 함께 풀되,<br/>판단은 내 것으로 남겨 보세요.</h2></div><Link className={styles.primary} href="/tasks">첫 과제 선택하기<Arrow/></Link></section>
 </div></LearningShell>}
